...
Use your RHDP-provided credentials to access the lab instructions. Once inside, you'll find a **Resources** panel on the right side of the page. Click to expand it and reveal links to all the demonstration components:
...
flowchart LR
    ...
    DB@{ img: "/solution-pattern-app-connect-ai/_images/database-icon.svg", label: "Database", pos: "b", h: 80, w: 80, constraint: "on" }
